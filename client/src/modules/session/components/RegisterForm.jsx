    ...
    <Form onSubmit={handleSubmit(submit)} className="register_form">
      ...
      <Form.Group className="mb-3" controlId="formBasicUser">
        <Form.Control {...register("userName", {
          ...
          {errors.userName?.type === "required" && <Form.Text className="text-muted">
          <ion-icon name="information-circle-outline" className="info_circle"></ion-icon>
           Campo requerido
          </Form.Text>}
          {errors.userName?.type === "minLength" && <Form.Text className="text-muted">
          <ion-icon name="information-circle-outline" className="info_circle"></ion-icon>
           Mínimo 6 caracteres
          </Form.Text>}
          {errors.userName?.type === "maxLength" && <Form.Text className="text-muted">
          <ion-icon name="information-circle-outline" className="info_circle"></ion-icon>
           Demasiados caracteres, intenta un nombre de usuario más corto
          </Form.Text>}
          {errors.userName?.type === "pattern" && <Form.Text className="text-muted">
          <ion-icon name="information-circle-outline" className="info_circle"></ion-icon>
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Control {...register("email", {
          ...
          {errors.email?.type === "minLength" && <Form.Text className="text-muted">
          <ion-icon name="information-circle-outline" className="info_circle"></ion-icon>
          Mínimo 8 caracteres
          </Form.Text>}
          {errors.email?.type === "maxLength" && <Form.Text className="text-muted">
          <ion-icon name="information-circle-outline" className="info_circle"></ion-icon>
      ...
      <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Control {...register("password", {
          ...
          {errors.password?.type === "maxLength" && <Form.Text className="text-muted">
          <ion-icon name="information-circle-outline" className="info_circle"></ion-icon>
